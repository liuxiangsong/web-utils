...
<vxe-table  
          ...
          <vxe-table-column field="role" title="角色" :title-help="{message: '自定义图标', icon: 'el-icon-edit-outline'}"></vxe-table-column>
        ...
        showTooltipMethod ({ type, column, row, items, _columnIndex }) {
            ...
            if (property === 'role' || property === 'date') {
                if (type === 'header') {
                    ...
                    return items[_columnIndex] ? '自定义表尾提示内容，并且自定义换行：' + items[_columnIndex] : ''
                }
